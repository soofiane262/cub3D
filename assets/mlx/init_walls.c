...
/*   Updated: 2022/08/17 12:36:35 by sel-mars         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../cub3d.h"

static void	init_north_wall(t_cub *cub)
{
	int	tmp[2];
...
static void	init_south_wall(t_cub *cub)
{
	int	tmp[2];
...
static void	init_east_wall(t_cub *cub)
{
	int	tmp[2];
...
static void	init_west_wall(t_cub *cub)
{
	int	tmp[2];
