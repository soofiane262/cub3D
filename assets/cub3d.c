...
/*   Updated: 2022/07/27 18:23:20 by sel-mars         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	cub3d(int ac, char **av)
{
	...
	cub->tmp_int = 0;
	cub->tmp_int2 = 0;
	mlx_hook(cub->mlx.win_ptr, ON_KEYPRESS, 0, key_press, cub);
	mlx_hook(cub->mlx.win_ptr, ON_KEYRELEASE, 0, key_release, cub);
